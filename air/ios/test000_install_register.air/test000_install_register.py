...
touch(Template(r"tpl1708935087881.png", record_pos=(-0.409, -0.783), resolution=(750, 1334)))
wait(Template(r"tpl1708935151440.png", record_pos=(-0.004, 0.644), resolution=(750, 1334)))
swipe(Template(r"tpl1708935113787.png", record_pos=(0.003, 0.645), resolution=(750, 1334)), vector=[-0.0135, -0.5])
wait(Template(r"tpl1708935556568.png", record_pos=(0.0, 0.645), resolution=(750, 1334)))
touch(Template(r"tpl1708935556568.png", record_pos=(0.001, 0.647), resolution=(750, 1334)))
exists(Template(r"tpl1708935697077.png", record_pos=(0.003, -0.316), resolution=(750, 1334)))
clear_app('com.tiqmo.wallet.ksa.uat')
